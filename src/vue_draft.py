...
# self.type_de_tours = ["Mitrailleuse", "Poison", "Éclair", "Mines", "Canon", "Grenade", "Ralentissement", "Argent", "Boost", "Repoussante"]
#
# Pour choisir le bon type de tour, utiliser les string définie plus haut.
#
#        for type in self.type_de_tours:
#            btn_creer_tour=Button(aire_commande, text=type)
#            btn_creer_tour.bind("<Button>", self.demander_tour)
#            btn_creer_tour.pack()
#
# self.demander_tour simplifier
...
class Vue():
    def __init__(self, parent, nom_joueur_local):
        ...
        self.type_de_tours = ["tour", "Poison", "Éclair", "Mines", "Canon", "Grenade", "Ralentissement", "Argent", "Boost", "Repoussante"]
    ...
    def creer_cadre_lobby(self, local_ou_reseau, joueurs):
        ...
        self.btn_lancer_partie=PacManButton(self.canevas_lobby,text="Debuter la partie",
        ...
        ##
        # Create a matrix of PacManButtons for board selection on the canvas
        x = 200
        y = 350
        for rang in range(3):
            x = x + 100
            no_tablo = rang
            self.btn_tablo = PacManButton(self.canevas_lobby, text=f"Tableau {no_tablo}")
    ...
    def creer_cadre_splash(self, nom_joueur_local):
        ...
        self.btnurlconnect = PacManButton(text="Connecter", font=("Arial", 12), command=self.initialiser_splash_post_connection)
        ...
        self.btncreerpartie = PacManButton(text="Creer partie reseau", state=DISABLED, command=self.creer_partie)
        self.btninscrirejoueur = PacManButton(text="Inscrire a partie reseau", state=DISABLED,
                                        command=self.inscrire_joueur)
        self.btnreset = PacManButton(text="Reinitialiser partie", state=DISABLED,
        ...
        self.btn_ouvrir_lobby_local=PacManButton(cadre_splash,text="Creer partie locale",command=self.ouvrir_lobby_local)
        self.btn_ouvrir_bonus=PacManButton(cadre_splash,text="Ouvrir magasin de Bonus",command=self.ouvrir_bonus)
    ...
    def creer_cadre_jeu(self):
        ...
        btn_activer_partie=PacManButton(aire_commande,text="Activer la partie",command=self.activer_partie)
        btn_activer_partie.pack()

        for type in self.type_de_tours:
            btn_creer_tour=PacManButton(aire_commande, text=type)
            btn_creer_tour.bind("<Button>", self.demander_tour)
            btn_creer_tour.pack()
    ...
    def demander_tour(self, evt):
        type = evt.widget.cget('text')
        self.action = Action(self, type)
...
class PacManButton(Button):
    def __init__(self,*args, **kwargs):
        ...
        # button_border = Frame(self, highlightbackground = "goldenrod3",  
        #                  highlightthickness = 2, bd=0) 
        # https://www.geeksforgeeks.org/how-to-add-a-border-color-to-a-button-in-tkinter/
        self['bg'] = 'black'
        self['fg'] = 'goldenrod3'
        self['font'] = ("Gill Sans Ultra Bold", 10)
        self['width'] = 15
