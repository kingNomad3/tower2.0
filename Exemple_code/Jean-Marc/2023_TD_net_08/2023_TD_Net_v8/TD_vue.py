...
class Vue():
    ...
    def afficher_partie(self):
        ...
        # maintenant le score
        self.canevas.create_text(self.modele.largeur / 4, self.modele.hauteur / 8*7, anchor=CENTER,
                                 font=('Helvetica', '30', 'bold'),
                                 text=self.modele.niveau, tags=("dynamique", "pointage"))
        self.canevas.create_text(self.modele.largeur / 4 * 2, self.modele.hauteur / 8*7, anchor=CENTER,
                                 font=('Helvetica', '30', 'bold'),
                                 text=self.modele.pointage, tags=("dynamique", "pointage"))

        self.canevas.create_text(self.modele.largeur / 4 * 3, self.modele.hauteur / 8*7, anchor=CENTER,
                                 font=('Helvetica', '30', 'bold'),
    ...
    # on avertit le serveur de lancer la premiere vague
